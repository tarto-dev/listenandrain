...
<head>
    ...
    <style type="text/css">
        * { margin: 0; padding: 0; }
        ...
        body {height:100%; width: 100%; background: white; background-image: url('<?php echo printf('backgrounds/%s.gif', $imageID); ?>'); background-size: cover; background-position: 50% 50%;}
